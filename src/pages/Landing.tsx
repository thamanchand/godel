...
const LandingPage: React.FC<LandingPageProps> = ({ user }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-md shadow-sm z-50 animate-slide-down">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              <img src="/logo.svg" alt="Logo" className="h-8 w-8 animate-fade-in" />
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <a
                href="#features"
                className="text-gray-600 hover:text-primary-600 transition-all hover:scale-105"
              >
                Features
              </a>
              <a
              ...
              {user ? (
                ...
                <button
                  ...
                  className="bg-primary-600 hover:bg-primary-700 text-white px-6 py-2 rounded-lg transition-all hover:scale-105 hover:shadow-lg"
                >
                  Sign In
                </button>
              )}
            ...
            {/* Mobile menu button */}
            <button className="md:hidden bg-gray-100 p-2 rounded-lg hover:bg-gray-200 transition-colors">
              <svg
      ...
      <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-radial from-primary-50 to-transparent opacity-50" />
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center animate-slide-up">
            ...
            <button
              ...
              className="bg-primary-600 hover:bg-primary-700 text-white text-lg px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 hover:scale-105"
            >
            ...
            {[
              ...
              <div
                ...
                className={`group bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 relative ${
                  plan.isPopular ? 'ring-2 ring-primary-400' : ''
                }`}
              >
                {plan.isPopular && (
                  <span className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-primary-600 text-white px-4 py-1 rounded-full text-sm font-medium shadow-lg">
                    Most Popular
                  </span>
                )}
                <h3 className="text-xl font-semibold mb-4 text-gray-900">{plan.name}</h3>
                <p className="text-4xl font-bold mb-6 text-primary-600">
                  {plan.price}
      ...
      <section id="contact" className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            ...
            className="inline-flex items-center bg-primary-600 hover:bg-primary-700 text-white px-8 py-4 rounded-lg transition-all hover:scale-105 hover:shadow-lg"
          >
      ...
      <footer className="bg-gray-900 text-gray-300 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-white font-semibold mb-4">RouteOptimizer</h3>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-sm text-center">
            © {new Date().getFullYear()} RouteOptimizer. All rights reserved.
          </div>
        </div>
      </footer>
